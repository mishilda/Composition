...
import com.mishilda.composition.data.GameRepositoryImpl
...
import com.mishilda.composition.domain.usecases.GenerateQuestionUseCase
import com.mishilda.composition.domain.usecases.GetGameSettingUseCase
...
class GameViewModel(
    ...
    private val generateQuestionCaseUseCase = GenerateQuestionUseCase(repository)
    ...
    private fun generateQuestion() {
        _question.value = generateQuestionCaseUseCase(gameSettings.maxSumValue)
    }
